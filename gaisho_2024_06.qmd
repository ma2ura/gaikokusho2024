...
- **Analytical review procedures** are applied at several points in a firm’s audit to establish
  "<mark class="mark">plausible relationships among both financial and non-financial data</mark>"
  as a cost-effective test of the conclusions derived from fieldwork.
...
- Prior to interim and substantive fieldwork, they play an essential role in assisting the auditor to
  "adequately plan work" and "obtain a sufficient understanding of the entity and its environment."
- Prior to fieldwork, <mark class = "mark">auditors have very little access to client transactions</mark>
  (which may not have yet occurred) and analytical procedures based on industry and economy-wide news offer cost-effective tools for audit planning.
...
- Audit technologies now use **objective statistical methods** to support or replace auditor judgment,
  making audits more cost-effective and reducing the risk of errors.
...
- Official pronouncements of the AICPA on **the nature and objectives of analytical review** support theoverall objectives of an audit: <mark class = "mark>discovery of material errors in the financial statements </mark>.
- Analytical review procedures flexibly and opportunistically rely on external information available at the time of planning the audit;
  they depend heavily on non-transaction data sources, and typically need to make explicit or implicit assumptions about the underlying statistical characteristics of such data and its relevance to the financial statements to be audited.
<!--
...
1. *Avoid mechanical computations and comparisons* .
   Instead, determine trends, ratios, and relationships that are most relevant to the business.
   Develop expectations on plausible or predictable relationships based on historical patterns in the
   operation of the business.
   These will serve as benchmarks for comparisons to determine unusual or unexpected changes.
...
:::{.notes}
1. 年次の資金調達活動からの収入を総支援と比較する。これにより、収益認識に関する問題を発見するのに役立ちます。
2. 過去5年間の支援と収入源を比較します。これにより、より詳細な検討が必要な収入源が明らかになる場合があります。
3. 資金調達費用と寄付収入の比率を評価します。記録された収入に対する低い費用は、収益が過大評価されていることを示す可能性があります。寄付収入に対してほとんどまたはまったく資金調達費用がない場合、費用比率を有利に保つために費用が過小報告されている可能性があります。
:::

## Typical Analytical Procedures (cont.)
...
:::{.notes}
4財務情報をスキャンして、エラーのリスクが高い領域を強調する可能性のある異常な変化、予期しないパターン、または大きな変動を特定します。たとえば、負債の大幅な増加は新しいローンを示唆する可能性があり、総純資産や異なる資産クラス（非制限、一時的制限、永久的制限）の大きな変化は、組織の持続可能性に関する懸念や不利なトレンドを示す可能性があります。
5前回の監査から情報を取得します。これにより、監査人は、重要な勘定科目に関する固有のリスクと制御リスクについての予備的な判断を下し、検出リスクを低減するための実体手続きに焦点を当てることができます。
:::
...
1. **"Nominal" accounts** (名目勘定) for tracking activity; closing out these accounts at year-end yields the net income amount, which arguably is the most important single statistic produced in the accounting process from a stockholders perspective.
...
- **Debt-to-equity ratio**: compares a company’s total debt to shareholders’ equity. Both of these numbers can be found on a company’s balance sheet. To calculate debt-to-equity ratio, you divide a company’s total liabilities by its shareholder equity, or
  - <mark class = "mark">Debt-to-Equity Ratio = Total Liabilities / Shareholders’ Equity </mark>.
...
- This ratio shows how efficiently a company manages its inventory.
  - <mark class = "mark"> Inventory Turnover Ratio = Cost of Sales / Average Inventory for the Period</mark>.
...
- **Operating margin**: compares a company’s operating income to net revenues. Both of these numbers can be found on a company’s income statement. To calculate operating margin, you divide a company’s income from operations (before interest and income tax expenses) by its net revenues, or
  - <mark class = "mark">Operating Margin = Income from Operations / Net Revenues</mark>.
...
- **P/E ratio**: compares a company’s common stock price with its earnings per share. To calculate a company’s P/E ratio, you divide a company’s stock price by its earnings per share, or
  - <mark class = "mark">P/E Ratio = Price per share / Earnings per share</mark>.
...
- **Working capital**: is the money leftover if a company paid its current liabilities (that is, its debts due within 1-year of the
  ...
  - <mark class = "mark">Working Capital = Current Assets - Current Liabilities </mark>
...
- The _R_ language is ideal for ad hoc intelligence scanning, with packages that support one-off analyses of Internet data and datastreams.
